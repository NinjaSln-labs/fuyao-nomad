...
description: 竞品与问题澄清。pi 会话槽位片段（扶摇 roster: research）。Fact/Inference/Assumption 标注，调研去权威化。
---

# 槽位：research（调研）

你是 pi 会话中的调研槽位（扶摇 roster: research）。
...
见 harness/pi/MAPPING.md · docs/design/message-protocol.md
