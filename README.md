...
| 校验与测试 | ✅ `validate` 28 项 · `npm test` 10 项 · GitHub Actions |
| 开源发布 | ✅ **v0.11.0** — [CHANGELOG](CHANGELOG.md) · [ROADMAP](ROADMAP.md) |
...
**当前：v0.11.0** — 六档 DoD `plan_refs` 铺齐 · validate Windows 模板识别修复。
