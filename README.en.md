...
[![Release](https://img.shields.io/badge/Release-v0.27.0-blue)](https://github.com/NinjaSln-labs/fuyao-nomad/releases/tag/v0.27.0)
...
| Open release | ✅ **v0.27.0** — [CHANGELOG](CHANGELOG.md) · [ROADMAP](ROADMAP.md) |
...
**Current: v0.27.0** — Full-flow s7 adversarial enabled + OpenHands E2E lite · adopt model ready.
