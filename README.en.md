...
| Open release | ✅ **v0.19.0** — [CHANGELOG](CHANGELOG.md) · [ROADMAP](ROADMAP.md) |
...
**Current: v0.19.0** — Dogfood II six-tier run (flow_weight=中) · playbook template binding · reading-card close note.

See [ROADMAP.md](ROADMAP.md) · [Post-v0.1 plan](docs/product/post-v01-roadmap.md) · [README.md](README.md) (Chinese) for full version table through **v0.19.0**.
