...
[![Release](https://img.shields.io/badge/Release-v0.22.0-blue)](https://github.com/NinjaSln-labs/fuyao-nomad/releases/tag/v0.22.0)
...
**Current: v0.22.0** — Complete dogfood playbook (steps 0–8) · official pack with cursor+CLI dual mapping.
