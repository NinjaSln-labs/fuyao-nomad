...
[![Release](https://img.shields.io/badge/Release-v0.26.0-blue)](https://github.com/NinjaSln-labs/fuyao-nomad/releases/tag/v0.26.0)
...
| Open release | ✅ **v0.26.0** — [CHANGELOG](CHANGELOG.md) · [ROADMAP](ROADMAP.md) |
...
**Current: v0.26.0** — Release discipline + adopt model (parallel product handoff sandboxes) · dogfood matrix complete.
