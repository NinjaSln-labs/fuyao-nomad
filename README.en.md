...
[![Release](https://img.shields.io/badge/Release-v0.11.0-blue)](https://github.com/NinjaSln-labs/fuyao-nomad/releases/tag/v0.11.0)
...
| Open release | ✅ **v0.11.0** — [CHANGELOG](CHANGELOG.md) · [ROADMAP](ROADMAP.md) |
...
**Current: v0.11.0** — DoD `plan_refs` across all six `flow_weight` tiers · Windows validate template basename fix.
